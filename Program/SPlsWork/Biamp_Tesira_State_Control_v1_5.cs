...
namespace UserModule_BIAMP_TESIRA_STATE_CONTROL_V1_5
{
    public class UserModuleClass_BIAMP_TESIRA_STATE_CONTROL_V1_5 : SplusObject
    {
...
public UserModuleClass_BIAMP_TESIRA_STATE_CONTROL_V1_5 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
